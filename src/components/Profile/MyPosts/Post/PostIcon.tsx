...
export const PostIcon = () => {
  return (
    ...
    <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/WhatsApp_font_awesome.svg/1024px-WhatsApp_font_awesome.svg.png' />
        </li>
    ...
    <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Font_Awesome_5_brands_instagram.svg/1200px-Font_Awesome_5_brands_instagram.svg.png'/>
        </li>
        <li  className={`${s.social_item} ${s.google}`}>
    <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Font_Awesome_5_brands_google-plus-g.svg/1279px-Font_Awesome_5_brands_google-plus-g.svg.png'/>
        </li>
